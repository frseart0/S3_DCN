...
public class AwsS3Service {
	...
	public List<S3ObjectDto> listObjects(String bucket) {
		return listObjectsByPrefix(bucket, null);
	}

	/**
	 * Lista objetos en un bucket filtrados por prefijo (fecha/transportista/)
	 */
	public List<S3ObjectDto> listObjectsByPrefix(String bucket, String prefix) {
	...
	public void uploadBytes(String bucket, String key, byte[] content, String contentType) {
		...
		try {
			log.info("Subiendo bytes al bucket: {}, clave: {}, tamaño: {} bytes", bucket, key, content.length);
